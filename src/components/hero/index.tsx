...
export const Hero = () => {
  return (
    <div className="w-full flex bg-[url(/hero.png)] bg-cover overflow-x-hidden relative md:min-h-[800px] min-h-[1100px]">
      ...
      <div className="w-full px-8 flex items-center justify-center py-10 flex-wrap md:justify-around gap-6 z-10 relative">
        ...
        <HeroForm />
        <div className=" absolute md:bottom-0 bottom-[-100px] w-full h-[120px] flex">
